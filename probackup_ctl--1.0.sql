...
CREATE FUNCTION probackup.backup(catalog_id INT,
	   pg_instance TEXT,
...
CREATE FUNCTION probackup.delete(catalog_id INT,
	   pg_instance TEXT,
	   backup_id TEXT
)
RETURNS TEXT
...
CREATE FUNCTION probackup.log(catalog_id INT, pg_instance TEXT, backup_id TEXT)
RETURNS TEXT
